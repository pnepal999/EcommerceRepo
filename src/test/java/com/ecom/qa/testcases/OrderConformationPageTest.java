...
public class OrderConformationPageTest extends TestBase{
	...
	public void setUp() {
		...
		confirmedorderpage.VerifyConfirmedMyOrderLink();
		orderconfirmationPage = new OrderConfirmationPage();

	}	
	@Test
	public void VerifyOrderConformationTitlePageTest() {
		String title=orderconfirmationPage.ValidateTitlePageOfOrderConfirmationPage();
		Assert.assertEquals(title, "Order confirmation - My Store"," fail reason: title not match");
	}
	@Test
	public void VerifyOrderConformationTextTest() {
		String text = orderconfirmationPage.ValidateOrderConformationText();
		Assert.assertEquals(text, "order-confirmation","failed reson: text not match ");
